...
//톰캣을 사용하므로 jsp파일을 자동으로 class로 변환을 했다면,
//이제는 직접 클래스를 만들어서 클래스로 요청을 처리해 보자는 것입니다.(con.jsp)
...
public class ServletBasic extends HttpServlet {
	...
	//3. HttpServlet이 제공하는 상속 메서드를 오버라이딩합니다.
	...
	public void init() throws ServletException {
		/*
		 ...
		 - init()는 컨테이너(server)에 의해 서블릿 객체가 생성될 때
		  최초 1회 자동으로 호출됩니다.
	...
	public void destroy() {
		/*
		 - 서블릿 객체가 소멸할 때 호출되는 메서드(객체 소멸 시 1회 자동으로 호출)
